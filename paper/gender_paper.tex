...
\title{Studying Gender in AAS Talks -- data from the 223rd meeting of the American Astronomical Society}
\author{
...
\begin{itemize}
\item[1.] Men ask disproportionally more questions than women in talks, despite the gender ratio of the speakers matching that of the conference attendees.
\item[2.] Women are asked slightly more questions per talk than men (3.28 versus 2.64, respectively.)
\item[3.] The gender of the session chair appears to have a strong correlation with the gender ratio of the questioners.
\end{itemize}
